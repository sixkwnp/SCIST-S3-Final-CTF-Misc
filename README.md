...
> :::
> [name=SCIST.Entry.forensics.txt][color=#60b7e0]
...
> :::
> [name=confidential.cam][color=#60b7e0]
...
> :::
> [name=Andrew\1.txt][color=#60b7e0]
...
> :::
> [name=Zoe\1.txt && Zephyr\1.txt][color=#60b7e0]
...
- ![](https://hackmd.io/_uploads/BkgGCPW9h.png)
 > [color=#10fcd5][name=112f3a99b283a4e1788dedd8e0e5d35375c33747.png]
:::success
* **Final FLAG : ||SCIST{Vol4T1L17Y_C4N_do_4LL_Non53nse_M3MFoR3Ns1cs}||**
![](https://hackmd.io/_uploads/rJgxuHBK2.png)
:::
